...
# exists = len(list(client.list_blobs("jaxformer-test-bucket2", prefix="checkpoints/testRun", max_results=1))) > 0
# path = "gs://results_jaxformer/"
# name = "hell"

# print(exists)

path = "gs://results_jaxformer/hello"
breakpoint()
