...
loss_, predictions_ = jax.jit(loss_pp)(params_, batch_)
naive_loss, naive_predictions = jax.jit(loss)(params, batch)

diff = jnp.max(jnp.abs(predictions_ - naive_predictions))
print(diff)